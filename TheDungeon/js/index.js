...
function gamestart() {
  ...
  if (q1.toLowerCase() === "right") {
    ...
    if (q2.toLowerCase() === "attack aggressively")
      alert("You swing your sword as fast as possible towards the orc. You manage to cut him a few times, but his battle-axe swings downwards towards your head before you can swing your sword again. You are dead.");
    ...
    if (q3.toLowerCase() === "liberatem")
      alert("You open the door and are greeted by the warm sunlight and the soothing sounds of birds chirping. You breath a sigh of relief and walk back to your home.");
  } //end of q3 if
}
